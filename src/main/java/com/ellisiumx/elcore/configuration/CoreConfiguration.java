...
public class CoreConfiguration {
    ...
    public CoreConfiguration(ELCore context) {
        Database_Enabled = context.getConfig().getBoolean("database.needed");
        Database_Type = context.getConfig().getString("database.type");
        Database_Filename = context.getConfig().getString("database.filename");
        ...
        Redis_Enabled = context.getConfig().getBoolean("redis.needed");
