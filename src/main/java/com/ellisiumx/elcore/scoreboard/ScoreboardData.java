...
import com.ellisiumx.elcore.scoreboard.elements.ScoreboardElement;
import com.ellisiumx.elcore.scoreboard.elements.ScoreboardElementScores;
import com.ellisiumx.elcore.scoreboard.elements.ScoreboardElementText;
...
public class ScoreboardData {
    ...
    public ArrayList<String> getLines(ScoreboardManager manager, Player player) {
        ...
        for (ScoreboardElement elem : elements) output.addAll(elem.GetLines(manager, player));
        return output;
    }
    ...
    public void writeOrdered(String key, String line, int value, boolean prependScore) {
        if (prependScore) line = value + " " + line;
        line = prepareLine(line);
